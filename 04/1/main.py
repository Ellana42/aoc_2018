...
print(guards)
biggest_sleeper = max(guards, key=lambda x : sum(guards[x]))
print(f"biggest_sleeper {biggest_sleeper}")
minute_most_asleep = argmax(guards[biggest_sleeper])
print(f"minute_most_asleep {minute_most_asleep}")
print(f"answer : {biggest_sleeper * minute_most_asleep}")
